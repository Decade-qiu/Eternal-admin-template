    ...
    <el-card>
        <el-form inline>
            <el-form-item label="一级分类">
                <!-- change:选中值发生变化时触发 -->
                <el-select :disabled="scene" v-model="categoryStore.c1Id" placeholder="Select"
                    @change="handler" style="width: 200px">
            ...
            <el-form-item label="二级分类">
                <!-- change:选中值发生变化时触发 -->
                <el-select v-model="categoryStore.c2Id" placeholder="Select"
                    @change="handler1" style="width: 200px">
                    <!-- label:即为展示数据 value:即为select下拉菜单收集的数据 -->
